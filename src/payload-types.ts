...
export interface Config {
  ...
  jobs: {
    tasks: {
      importFinishedRaces: TaskImportFinishedRaces;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'importFinishedRaces';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'importFinishedRaces') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskImportFinishedRaces".
 */
export interface TaskImportFinishedRaces {
  input?: unknown;
  output?: unknown;
}
/**
